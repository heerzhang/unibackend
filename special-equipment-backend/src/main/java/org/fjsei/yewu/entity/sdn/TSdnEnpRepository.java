...
public interface TSdnEnpRepository extends JpaRepository<TSdnEnp,String> {
    ...
    //TSdnEnp findTopByUntNameAndTebmuser_LoginNameAndStatusNotEquals(String untName, String loginName, String status);
    //新版本JPA升級后，不好使咯
    TSdnEnp findTopByUntNameAndTebmuser_LoginNameAndStatusIsNotLike(String untName, String loginName, String status);
