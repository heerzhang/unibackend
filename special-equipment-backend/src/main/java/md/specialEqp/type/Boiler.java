...
public class Boiler extends Eqp {
    ...
    //todo: 改成Enum形式  IF_VERTICAL ？ MAINSTRFORM 合并字段
    private String  form;  //IF_VERTICAL锅炉结构形式@[{id:'立式',text:'立式'},{id:'卧式',text:'卧式'} "锅壳式"] 锅炉结构形式MAINSTRFORM: "锅壳式"
    ...
    private String  btp;
    private Float  pres;    //额定工作压力DESWORKPRESS
    private String  bmod;   //燃烧方式BURNMODE
}
